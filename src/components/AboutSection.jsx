...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="w-full bg-gradient-to-br from-[#6E6054] via-[#65574B] to-[#57493E] text-[#FAF7F2] py-20 sm:py-28 px-4 sm:px-6 lg:px-12 scroll-mt-24 shadow-inner">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          
          {/* Left Column (5 cols): Framed & Taped Photo Card (Reference Design Styling) */}
          <div className="lg:col-span-5 relative flex flex-col items-center justify-center">
            {/* Taped Matting Card */}
            <div className="relative w-full max-w-[370px] sm:max-w-[410px] mx-auto bg-white p-3.5 sm:p-4 rounded-sm shadow-[0_25px_50px_rgba(0,0,0,0.35)] -rotate-1 hover:rotate-0 transition-transform duration-500 group">
            ...
            <div className="absolute -bottom-4 right-2 sm:-bottom-4 sm:right-6 bg-[#2B231D]/90 backdrop-blur-md text-white rounded-2xl p-4 shadow-2xl border border-white/10 flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-[#E7DFD5]/80">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base text-[#E7DFD5] leading-relaxed font-normal pt-2">
              ...
              <p className="text-sm sm:text-base text-[#E7DFD5]/90 leading-relaxed font-normal">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              {highlights.map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 flex items-start gap-3.5 hover:bg-white/15 transition-colors"
                  >
                    <div className="w-10 h-10 rounded-xl bg-coral/25 text-[#FFB69B] flex items-center justify-center shrink-0 mt-0.5 border border-coral/30">
                      <Icon size={18} />
                    </div>
                    <div>
                      <h4 className="font-bold text-sm text-[#FAF7F2] mb-1">
                        {item.title}
                      </h4>
                      <p className="text-xs text-[#E7DFD5]/85 leading-relaxed">
                        {item.desc}
                      </p>
                    </div>
                  </div>
            ...
            {/* Minimalist Editorial Buttons (Matching Reference Design Style) */}
            <div className="pt-3 flex flex-wrap items-center gap-4">
              <Link
                to="/about"
                className="px-8 py-3.5 border border-[#E7DFD5]/70 hover:border-white text-[#FAF7F2] hover:bg-[#FAF7F2] hover:text-[#57493E] tracking-[0.2em] uppercase text-xs font-bold transition-all duration-300 shadow-sm"
              >
                Learn More About Us
              </Link>
              ...
              <Link
                to="/pricing"
                className="inline-flex items-center gap-2 px-8 py-3.5 bg-coral hover:bg-coral-dark text-white tracking-[0.2em] uppercase text-xs font-bold transition-all duration-300 shadow-xl shadow-black/20"
              >
