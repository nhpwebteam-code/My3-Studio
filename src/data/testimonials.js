...
export const testimonials = [
  ...
  {
    id: 3,
    quote: "I usually dread having my picture taken, but the session felt effortless and deeply authentic. The portraits possess a timeless painterly depth that exceeded all expectations.",
    author: "Dr. Meera Nambiar",
    context: "Executive Portrait Session",
    rating: 5,
